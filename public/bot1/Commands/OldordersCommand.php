 ...
 */
class OldordersCommand extends SystemCommand
{
    /**
     * @var string
     */
    protected $name = 'oldorders';

    /**
     * @var string
     */
    protected $description = 'Old orders';
    protected $usage = '/oldorders';
